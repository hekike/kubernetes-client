...
//
// Do our best to cleanup namespaces, but it's hard to ensure we don't leak.
//
function atexit() {
  if (testing('int') && module.exports.currentName) {
    module.exports.api.ns.delete({
      name: module.exports.currentName
    }, () => {});
  }
}
